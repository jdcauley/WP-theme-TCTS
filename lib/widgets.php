...
function roots_widgets_init() {
  ...
  register_sidebar(array(
    ...
    'id'            => 'footer-left',
    'before_widget' => '<section class="widget footer-left %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>',
  ));
  ...
  register_sidebar(array(
    ...
    'id'            => 'footer-center',
    'before_widget' => '<section class="widget footer-center %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>',
  ));
  ...
  register_sidebar(array(
    ...
    'id'            => 'footer-right',
    'before_widget' => '<section class="widget footer-right %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>',
  ));
